 ...
 <head>
     ...
     <header>
         <div class="header">
             <a class="logo" href="home.html">qwertyuiopa</a>
             <div class="reddit-button" onclick="reddit()">
                     <svg class="reddit-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xml:space="preserve">
                        <defs>
                        </defs>
                        ...
                        <p class="reddit-text">u/qwertyuiopa69</p>
                        </div>
             </div>
             </header>
             <body>
                 <div class="websitebutton" id="html-editor-button" onclick="htmleditor()">
                     <p class="websitebutton-text" id="html-editor-text">HTML Editor</p>
                     <img class="websitebutton-image" id="html-editor-image" src="html_editor.png">
                 </div>
                 <div class="websitebutton" id="notepadbutton" onclick="notepad()">
                     <p class="websitebutton-text" id="notepadtext">Windows Notepad<br>Online</p>
                     <img class="websitebutton-image" id="notepad-image" src="notepad.png">
                     </div>
